<template>
    <form @submit.prevent="saveQuiz">
        ...
        <button type="submit" class="mt-7 text-white bg-green-600 hover:bg-green-900 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Créer</button>
    </form>
</template>
