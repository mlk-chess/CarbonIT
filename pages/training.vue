        ...
        <ul class="flex flex-wrap -mb-px text-sm font-medium text-center text-gray-500 dark:text-gray-400">
          <li class="mr-2">
            <span @click="mode = 'training'"
                  ...
                  :class="{'': true, 'border-blue-600 text-blue-600': mode === 'training'}">
              <svg aria-hidden="true" :class="{'': true, 'text-blue-600': mode === 'training'}"
          ...
          <li class="mr-2">
            <span @click="mode = 'search'"
                  ...
                  :class="{'': true, 'border-blue-600 text-blue-600': mode === 'search'}">
              <svg aria-hidden="true" :class="{'': true, 'text-blue-600': mode === 'search'}"
