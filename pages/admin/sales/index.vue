        ...
        <dl class="grid gap-8 mx-auto text-gray-900 md:grid-cols-2 xl:grid-cols-4 dark:text-white">
          <div class="flex flec-row justify-center items-center align-middle bg-custom-white py-10 rounded">
            <div class="w-10 p-7 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900 -translate-x-1/2">
              <svg class="w-9 -translate-y-1/2 -translate-x-1/2 text-[#3A36DB] dark:text-primary-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z"></path>
              </svg>
            </div>
            <div class="flex flex-col justify-center items-center">
              <dt class="mb-2 text-3xl md:text-4xl font-extrabold">178 +  </dt>
              <dd class="font-light text-gray-500 dark:text-gray-400">Services favoris</dd>
            </div>
          </div>
          <div class="flex flec-row justify-center items-center align-middle bg-custom-white py-10 rounded">
            <div class="w-10 p-7 h-10 rounded-full bg-green-100 lg:h-12 lg:w-12 dark:bg-primary-900 -translate-x-1/2">
              <svg class="w-9 -translate-y-1/2 -translate-x-1/2 text-[#03A89E] dark:text-primary-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <dd class="font-light text-gray-500 dark:text-gray-400">Nouveaux clients</dd>
            </div>
          </div>
          <div class="flex flec-row justify-center items-center align-middle bg-custom-white py-10 rounded">
            <div class="w-10 p-7 h-10 rounded-full bg-pink-100 lg:h-12 lg:w-12 dark:bg-primary-900 -translate-x-1/2">
              <svg class="w-10 -translate-y-1/2 -translate-x-1/2 text-[#FF69B4] dark:text-primary-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 10.5V6a3.75 3.75 0 10-7.5 0v4.5m11.356-1.993l1.263 12c.07.665-.45 1.243-1.119 1.243H4.25a1.125 1.125 0 01-1.12-1.243l1.264-12A1.125 1.125 0 015.513 7.5h12.974c.576 0 1.059.435 1.119 1.007zM8.625 10.5a.375.375 0 11-.75 0 .375.375 0 01.75 0zm7.5 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z"></path>
              </svg>
            </div>
            <div class="flex flex-col justify-center items-center">
              <dt class="mb-2 text-3xl md:text-4xl font-extrabold">190 +</dt>
              <dd class="font-light text-gray-500 dark:text-gray-400">Nouveaux prospects</dd>
            </div>
          </div>
          <div class="flex flec-row justify-center items-center align-middle bg-custom-white py-10 rounded">
            <div class="w-10 p-7 h-10 rounded-full bg-blue-100 lg:h-12 lg:w-12 dark:bg-primary-900 -translate-x-1/2">
              <svg class="w-10 -translate-y-1/2 -translate-x-1/2 text-blue-600 dark:text-primary-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <dd class="font-light text-gray-500 dark:text-gray-400">Refferals</dd>
            </div>
          </div>
        </dl>
      </div>
