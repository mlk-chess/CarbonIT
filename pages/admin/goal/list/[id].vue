        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
          ...
          <tr v-for="(goal, index) in goals" :key="index">
            ...
            <th scope="row"
              ...
              <NuxtLink :href="`/`" class="ml-5 hover:cursor-pointer hover:text-blue-400">
              ...
              <NuxtLink :href="`/`" class="ml-5 hover:cursor-pointer hover:text-red-400">
                <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                    <path stroke-linecap="round" stroke-linejoin="round" 
      ...
      <div id="goal-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
          <div class="relative w-full max-w-md max-h-full">
            ...
            <form v-on:submit.prevent="saveGoal">
              ...
              <button type="submit"
                      class="mt-7 text-white bg-custom-red hover:bg-custom-green hover:text-black focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                Ajouter l'objectif
              </button>
            </form>
          </div>
