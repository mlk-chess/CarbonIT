    ...
    <div class="flex flex-row h-full w-full overflow-x-hidden">
      <div class="flex flex-col py-8 pl-6 pr-6 w-64 bg-white flex-shrink-0">
        <div class="flex flex-row items-center justify-center h-12 w-full">
          ...
          <div class="ml-2 font-bold text-2xl">CarbonChat</div>
        </div>
        <div
        ...
        >
          ...
          <div class="text-xs text-gray-500">Lead développeur</div>
          <div class="flex flex-row items-center mt-3">
            <div
              class="flex flex-col justify-center h-4 w-8 bg-custom-green rounded-full"
            >
              <div class="h-3 w-3 bg-white rounded-full self-end mr-1"></div>
            </div>
            <div class="leading-none ml-1 text-xs">En ligne</div>
          </div>
        </div>
              ...
              <div class="grid grid-cols-12 gap-y-2">
                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                  <div class="flex flex-row items-center">
                    <div
                      class="flex items-center justify-center h-10 w-10 rounded-full bg-custom-blue text-custom-white flex-shrink-0"
                    >
                      A
                    </div>
                    <div
                ...
                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                  <div class="flex flex-row items-center">
                    ...
                    <div
                      class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl"
                    >
                      <div>Tu penses quoi de la nouvelle appli interne ?</div>
                    </div>
                  </div>
                </div>
                <div class="col-start-6 col-end-13 p-3 rounded-lg">
                  <div class="flex items-center justify-start flex-row-reverse">
                    ...
                    >
                      <div>Salut ! Ça va bien et toi ?</div>
                    </div>
                  </div>
                </div>
                <div class="col-start-6 col-end-13 p-3 rounded-lg">
                  <div class="flex items-center justify-start flex-row-reverse">
                    ...
                    >
                      <div>
                        Eh bien, j'ai commencé à l'utiliser et je trouve que c'est vraiment pratique. Cela facilite vraiment l'organisation et la collaboration avec les autres membres de l'équipe.
                      </div>
                    </div>
                  </div>
                </div>
                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                  <div class="flex flex-row items-center">
                    ...
                    <div
                      class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl"
                    >
                      <div>Je suis tout à fait d'accord, c'est un outil magique.</div>
                    </div>
                  </div>
                </div>
                <div class="col-start-6 col-end-13 p-3 rounded-lg">
                  <div class="flex items-center justify-start flex-row-reverse">
                    ...
                    >
                      <div>
                        Tu as vu la fonctionnalité événement avec le calendrier de l'appli ? Elle est vraiment géniale !
                      </div>
                      <div
                ...
                <div class="col-start-1 col-end-8 p-3 rounded-lg">
                  <div class="flex flex-row items-center">
                    ...
                    >
                      <div>
                        Oui !! Heureusement que je suis tombé dessus, j'avais complètement oublié ! En plus ça va me permettre de m'organiser à l'avance pour être présent au maximum.
                      </div>
                    </div>
                  </div>
                </div>
