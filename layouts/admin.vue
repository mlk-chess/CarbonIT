  ...
  <div class=" h-screen fixed top-0 left-0 z-40">
    <div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-custom-black rounded">
      ...
      <div class="flex flex-col items-center mt-3 border-t border-gray-700">
        <NuxtLink class="flex items-center justify-center w-12 h-12 mt-2 hover:bg-gray-700 hover:text-gray-300 rounded"
                  href="/admin/user">
        ...
        <NuxtLink class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
                  href="#">
          <svg color="#FDFDFD" width="24" height="24" fill="none" stroke="currentColor" stroke-width="1.5"
               viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <a @click="logout"
         class="flex items-center justify-center w-16 h-16 bg-gray-800 hover:bg-gray-700 hover:text-gray-300" href="#">
